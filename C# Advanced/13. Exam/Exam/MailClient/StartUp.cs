namespace MailClient
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Mail mail1 = new("Sender", "Receiver", "Some 1 text message!");
            Mail mail2 = new("Sender2", "Receiver2", "Some 123 text message!");
            Mail mail3 = new("Sender34", "Receiver234", "Some 123 text message!");
